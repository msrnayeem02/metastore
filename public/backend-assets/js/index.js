$(function () {
  ...
  // chart 1 - safely check if canvas exists
  ...
  if (chart4Canvas) {
    var ctx = chart4Canvas.getContext('2d');
  ...
  // chart 5 – safely check if canvas exists
  var chart5Canvas = document.getElementById("chart5");
  if (chart5Canvas) {
    var ctx = chart5Canvas.getContext('2d');
